      ...
      <div className="max-w-5xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="glass-card p-10 text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-discord-blurple to-discord-fuchsia rounded-2xl flex items-center justify-center mx-auto mb-6">
            ...
            <button
              ...
              className="btn-primary w-full flex items-center justify-center gap-3 text-lg py-4 mb-6"
            >
